...
|---|---|---|
| Any multiplayer, RemoteEvent/Function, PvP, economy mutation | Network & Security Spec | authority matrix, payloads, validation, rate limits, replay/idempotency, ownership, abuse logs |
| DataStore, inventory, progression, settings, entitlement cache | Persistence & Migration Spec | schema version, defaults, session locking, migration, retry, corruption recovery, test/prod separation |
| Pass, Developer Product, subscription, purchasable currency | Commerce & Policy Spec | catalog, receipt ledger, entitlement, duplicate prevention, refunds, environment IDs, policy checks |
...
| Any GDD KPI or release metric | Analytics & Observability Spec | event dictionary, source, fields, volume, dashboards, alerts, privacy, test method |
...
| Any external/imported/AI-generated asset | Asset & Content Pipeline Spec | asset ledger, rights, naming, LOD, collision, moderation, fallback, ownership |
